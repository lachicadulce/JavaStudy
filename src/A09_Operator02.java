...
//		반드시 부등호가 먼저 나와야 함
		...
		*/
		...
		System.out.println("c가 짝수이면서 50보다 큰 수 인가요? " + (c % 2 == 0 && c > 50));
		System.out.println("c가 짝수이거나 50보다 큰 수 인가요? " + (c % 2 == 0 || c > 50));
		
//		연습문제: 변수 x, y, z가 모두 3의 배수가 아닐 때 true가 되는 비교 연산을 만들어보세요
		
		int x = 7, y = 5, z = 4;
//		boolean result = x % 3 != 0 && y % 3 != 0 && z % 3 != 0;
		boolean result = !(x % 3 == 0 || y % 3 == 0 || z % 3 == 0); // 두가지 방법
		System.out.printf("(%d, %d, %d)결과: " + result, x, y, z);
